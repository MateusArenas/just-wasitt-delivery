  ...
  React.useLayoutEffect(() => {
    navigation.setOptions({
      ...
      headerRight: ({ tintColor }: any) => (
        ...
        <IconButton onPress={() => rootNavigation.navigate('StoreOptions', { store })} name="notifications" size={24} color={tintColor} />
        <IconButton onPress={() => rootNavigation.navigate('StoreOptions', { store })} name="more-vert" size={24} color={tintColor} />
        </SafeAreaView>
      ),
    });
  }, [navigation]);
  ...
  return (
    <View style={{ flex: 1 }} >
      ...
      <View style={{//Bottom
        ...
        <Text {...textProps} style={{ padding: 10, fontWeight: 'bold' }}>Sacola</Text>
        <View style={{ flex: 1 }}/>
        <IconButton 
          name="expand-more"
          size={24}
          color={colors.text}
          onPress={() => rootNavigation.navigate('Checkout', { store })}
        />
      </View>
