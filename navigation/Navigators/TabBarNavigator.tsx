...
import useWindowDimensions from '@react-navigation/bottom-tabs/src/utils/useWindowDimensions';
  ...
  return (
    <Animated.View
      style={[
        ...
        style,
        vertical ? { width: tabBarHeight, height: dimensions.height } : { height: tabBarHeight, }
      ]}
      pointerEvents={isTabBarHidden ? 'none' : 'auto'}
    >
      <View style={[styles.content, vertical && { flexDirection: 'column' }]} onLayout={handleLayout}>
